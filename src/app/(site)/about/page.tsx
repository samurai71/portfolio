    ...
    <main>
      <section className="container mx-auto mb-3 h-full w-full rounded-xl p-4 px-3 pb-3 pt-3 shadow-xl shadow-gray-400">
        ...
        <p className="py-2">
          ...
          Next.js to build the web application interfaces and the
          functionalities.{" "}
        </p>
        <p className="py-2">
        ...
        <p className="py-2">
          ...
          websites interactive. I then started freelancing for companies. I am
        ...
        <p className="py-2">
          ...
          tutorials, documentations and articles. The first programming language
          I learned was Python. I also played around with databases.
        </p>
        <p className="py-2">
        ...
        <p className="py-2">
          You can do anything you can think of with these three things. Next.js
          is an open-source web development framework built on top of Node.js
