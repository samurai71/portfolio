              ...
              >
                <div className="grid w-full gap-4 py-2 md:grid-cols-2">
                  <div className="flex flex-col">
                    <label className="py-2 text-sm uppercase" for="name">
                      Name*
                    </label>
                    <input
                  ...
                  <div className="flex flex-col">
                    <label className="py-2 text-sm uppercase" for="phone">
                      Phone Number*
                    </label>
                    <input
                      className="flex rounded-lg border-2 border-gray-300 p-3"
                ...
                <div className="flex flex-col py-2">
                  <label className="py-2 text-sm uppercase" for="email">
                    Email*
                  </label>
                  <input
                    className="flex rounded-lg border-2 border-gray-300 p-3"
                ...
                <div className="flex flex-col py-2">
                  <label className="py-2 text-sm uppercase" for="subject">
                    Subject
                  </label>
                  <input
                    className="flex rounded-lg border-2 border-gray-300 p-3"
                ...
                <div className="flex flex-col py-2">
                  <label className="py-2 text-sm uppercase" for="message">
                    Message*
                  </label>
                  <textarea
